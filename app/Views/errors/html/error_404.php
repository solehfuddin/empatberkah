...
<div class="error">
  ...
  <div class="error__description">Sepertinya terjadi kesalahan </div>
  <br/>
  <a style="text-decoration: none" href="<?= base_url() ?>" class="error__button error__button--active">Kembali</a>
</div>
