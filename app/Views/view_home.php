        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="<?= base_url() ?>/public/images/project-1.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="<?= base_url() ?>/public/images/project-2.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="<?= base_url() ?>/public/images/project-3.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="<?= base_url() ?>/public/images/project-4.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="<?= base_url() ?>/public/images/project-5.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="<?= base_url() ?>/public/images/project-6.jpg" alt="alternative">
                        <div class="card-body">
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img class="testimonial-image" src="<?= base_url() ?>/public/images/testimonial-1.jpg" alt="alternative">
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <img class="testimonial-image" src="<?= base_url() ?>/public/images/testimonial-2.jpg" alt="alternative">
                                    <p class="testimonial-text">“Expense bed any sister depend changer off piqued one. Contented continued any happiness instantly objection yet her allowance. Use correct day new brought tedious. By come this been in. Kept easy or sons my it how about some words here done”</p>
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <img class="testimonial-image" src="<?= base_url() ?>/public/images/testimonial-3.jpg" alt="alternative">
                                    <p class="testimonial-text">“Expense bed any sister depend changer off piqued one. Contented continued any happiness instantly objection yet her allowance. Use correct day new brought tedious. By come this been in. Kept easy or sons my it how about some words here done”</p>
